...
const PrivacyPolicy = ({ theme = 'website' }) => {
  const cfg = themeConfig[theme] || themeConfig.website;
    ...
    <>
      ...
      >
        ...
        <Section icon={Trash2} title="8. HOW CAN YOU REVIEW, UPDATE OR DELETE YOUR DATA?">
          <p>You can request access to, update, or delete your personal information by contacting us at <a className="underline text-orange-700" href="mailto:support@ilonai.in">support@ilonai.in</a>.</p>
        </Section>

        <Section icon={Mail} title="9. HOW CAN YOU CONTACT US?">
          <p>If you have questions, email us at <a className="underline text-orange-700" href="mailto:support@ilonai.in">support@ilonai.in</a> or write to:</p>
          <p>
            ILON AI<br />
            Y7 001 GreenWood<br />
