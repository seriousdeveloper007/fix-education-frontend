      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          <RichTextPlugin
            ...
            placeholder={<div className="absolute left-3 top-3 text-slate-400 pointer-events-none">Type your notes here and they will be autosaved in library. You can paste screenshots and images.</div>}
          />
        </div>
        <HistoryPlugin />
