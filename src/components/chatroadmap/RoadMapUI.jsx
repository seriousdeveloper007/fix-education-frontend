            ...
            {nextModules.map((module, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  {/* Arrow Icon */}
                  <div className="flex-shrink-0 p-2 rounded-lg bg-slate-50/80 group-hover:bg-indigo-50 transition-colors duration-200">
                    <ArrowRight className="w-4 h-4 text-slate-400 group-hover:text-indigo-500 transition-colors duration-200" />
                  </div>
                </div>
              </div>
            ))}
