  ...
  app: {
    ...
    questionText: 'mt-2 text-sm text-gray-700 mb-1',
     ...
     roadmap: {
      ...
      videoContainer: 'bg-white/80 backdrop-blur-sm border border-white/40 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer group',
      videoThumbnailContainer: 'relative overflow-hidden rounded-lg mb-3',
      videoThumbnail: 'w-full h-48 object-cover transition-transform duration-200 group-hover:scale-105',
